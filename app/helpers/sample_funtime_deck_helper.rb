module SampleFuntimeDeckHelper
  ...
  def render_icecream_summary_card
    vis_config = {
      visualizations: [
        {id: 'icecream_radial_chart', type: 'radial', title: 'Ice Cream', data_source: 'collect_icecream_data', description: 'Flavors', style: 'cumulative', fill: true, show_legend: false},
